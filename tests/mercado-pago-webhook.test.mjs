...
test("parsear cabeçalho x-signature do Mercado Pago", () => {
  assert.deepEqual(signatureParts("ts=1700000000,v1=abcdef"), { ts: "1700000000", v1: "abcdef" });
});
...
test("reconhecer somente o payload oficial assinado do simulador", () => {
  assert.equal(isSignedSimulatorProbe({ body: simulatorBody, dataId: "123456" }), true);
});
