...
test("Vendas → checkout → billing confirmado → provisionamento → primeiro acesso",async({page})=>{
  ...
  await expect(page.locator("#checkoutResult")).toContainText("Pagamento aprovado e acesso liberado");
